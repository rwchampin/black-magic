...
export const JellyLogo = () => {
    ...
    useEffect(() => {
        ...
        const weightInit = style.getPropertyValue(600); // 600 in example
        const weightTarget = 400; // 100-800
        const weightDiff = weightInit - weightTarget;
        const stretchInit = style.getPropertyValue(150); // 150 in example
    ...
    return (
        <div className="stage">
            <div className="jelly-text-content">
                <h1 className="txt ryan" style={{fontSize: 150}}>Ryan</h1>
                <h1 className="txt the" style={{fontSize: 70}}>The</h1>
                <h1 className="txt dev" style={{fontSize: 180}}>Developer</h1>
            </div>
        </div>
    )
}